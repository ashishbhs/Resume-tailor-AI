...
// Simplified SVG icons to avoid external dependency issues in this format
// Using style similar to Lucide React
...
export const Star: React.FC<{ className?: string, fill?: string }> = ({ className, fill }) => (
